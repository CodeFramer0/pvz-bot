...
from .auth import (change_password_schema, current_user_schema,
                   email_login_schema, logout_schema, refresh_token_schema,
                   username_login_schema, verify_token_schema)
from .orders import (orders_create_schema, orders_destroy_schema,
                     orders_list_schema, orders_retrieve_schema,
                     orders_update_schema, orders_update_status_schema)
from .pickup_points import (pickup_points_by_marketplace_schema,
...
from .telegram_users import (telegram_users_list_schema,
                             telegram_users_retrieve_schema)
from .users import (users_create_schema, users_destroy_schema,
