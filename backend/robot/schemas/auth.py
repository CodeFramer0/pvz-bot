...
change_password_schema = extend_schema(
    ...
    request={
        "application/json": {
            ...
            "example": {"old_password": "old_pass123", "new_password": "new_pass123", "new_password_confirm": "new_pass123"}
        }
    },
    responses={
...
verify_token_schema = extend_schema(
    ...
    responses={
        ...
        400: {"type": "object", "example": {"valid": False, "detail": "Token is invalid or expired"}}
    }
)
